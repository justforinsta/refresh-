...
def setup_client_with_session(csrf_token, session_id):
    ...
    # Safely inject cookies into the underlying session
    session = cl.private._session
...
if submitted:
    with st.spinner("Logging in and reporting..."):
        ...
        if report_results:
            ...
            st.error("No reports were completed. Check sessions and targets.")
